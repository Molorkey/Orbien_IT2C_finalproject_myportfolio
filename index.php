...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
        ...
        <?php
        echo '<h1> <a href="index.php">Vincent Ray Orbien</a></h1>';
        echo '<h3> Nickname: Vincent </h3>';
        ?>
  ...
  <section id="" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
          ...
          <?php 
          echo "<h1>Vincent Ray Orbien</h1>";
          ?>
          <?php
          echo "<p>I'm a  Gamer, Novice Programmer</p>";
          ?>
